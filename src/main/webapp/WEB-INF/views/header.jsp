...
#navcontainer ul li a:hover {
	background: url("<c:url value="/ resources/ img/ menuActive.jpg " />")
		repeat-x;
	color: #FFFFFF;
}
...
<body>
	...
	<div id="container">
		...
		<div id="header">
			...
			<h1>
				<a href=""><span> </span> <span> </span> <span> </span> <span>
				</span> <span> </span> <span> </span><span> </span> SNIPPETSHARE </a>
			</h1>
			<div class="submenu">
				<ul>
					<li
						style="text-decoration: none; padding-right: 10px; color: #999999; padding-top: 10px; text-transform: uppercase;">
						<%=userId%>
					</li>
					<li><input class="btn" type="button" value="PENDING"
						onclick="createRequest('/snippetshare/viewPendingRequests', {}, 'post');">&nbsp;&nbsp;</li>
					<!-- <li><a href="#">PENDING RE</a></li> -->
					<li><input class="btn" type="button" value="LOGOUT"
						onclick="createRequest('/snippetshare/logout', {}, 'post');"></li>
